...
import type { Category, UseCategoriesPagedParams, UseCategoriesPagedResult } from "@/types/category";
...
export function useCategoriesPaged(
  params: UseCategoriesPagedParams,
): UseCategoriesPagedResult {
